package core.analysis.query.syntax.website;
...
public class WebsitePattern {
    private Set<WebsitePatternNode> nodes = new HashSet<>();
    private Set<WebsitePatternNodeConnection> connections = new HashSet<>();
